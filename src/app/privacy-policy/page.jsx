      ...
      <div className={styles.container}>
        <header className={styles.header}>
          ...
          <p className={styles.description}>
            Please read our privacy policy carefully before using InstaDl.app
            services.
          </p>
        </header>
        ...
        <div className={styles.content} aria-labelledby={titleId}>
          ...
          >
            <div className={styles.sectionContent}>
              ...
              <p>
                InstaDl.app is committed to protecting your privacy. We collect
                minimal information to provide our service:
              </p>
              <ul>
              ...
              <p>
                We do not store downloaded content on our servers. Instagram
                URLs are processed in real-time and not permanently stored. We
              ...
              <p>
                Our service may use third-party analytics tools to understand
                usage patterns. These services have their own privacy policies
              ...
              <p>
                ...
                experience and analyze service usage. You can control cookie
              ...
              <p>
                ...
                third parties except as required by law or to protect our legal
                rights.
              </p>
